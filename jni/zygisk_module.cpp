...
public:
    ...
    void preAppSpecialize(AppSpecializeArgs *args) override {
        ...
        // Targetkan seluruh aplikasi finansial dan pendeteksi root ketat
        if (strstr(process_name, "com.bca") || 
            ...
            // Paksa unmount seluruh denylist dan sembunyikan namespace suSFS
    ...
    void postAppSpecialize(const AppSpecializeArgs *args) override {
        // Netralkan variabel debug dan aksesibilitas secara mutlak di level memori proses
